...
public class DB_controller {
    ...
    public void getData(TextView textView)
    {
        ...
        {
            textView.append("Winner : "+cursor.getString(1)+ "\n");
        }
        cursor.close();
...
//        return buffer.toString();
    ...
    public void getData2(TextView textView) {
        SQLiteDatabase db = myhelper.getWritableDatabase();
        String[] columns = {myDbHelper.UID, myDbHelper.NAME, myDbHelper.SCORE};
        Cursor cursor;
        cursor = db.query(myDbHelper.TABLE_NAME, columns, null, null, null, null, null);
        textView.setText(" ");
        while (cursor.moveToNext()) {
            textView.append(" Score : " + cursor.getInt(2) + "\n");
        }
        cursor.close();
    }
    ...
    static class myDbHelper extends SQLiteOpenHelper
    {
        ...
        private static final String CREATE_TABLE = "CREATE TABLE "+TABLE_NAME+
                " ("+UID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+NAME+" VARCHAR(255) ,"+ SCORE+" INTEGER(50));";
