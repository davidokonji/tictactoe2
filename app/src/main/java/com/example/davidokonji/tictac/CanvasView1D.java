...
public class CanvasView1D extends View { //you have to create a new java file and then insert the same file in the xml of the page in which you want the canvas
    ...
    public CanvasView1D(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            if (oncedrawen || oncewin) {
                single_player_difficult.act_1d.finish();
            }
